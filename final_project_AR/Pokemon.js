		...
		if (this.layBabiesCounter == this.layBabiesTime) {
			...
			if (twinChance <= 19) {
				if (this.pokemonName == "magnemite") {
					var temp = new Pokemon(this.pokemonName, this.shadow, this.container.getX(), this.container.getY() * scaleFactor, this.container.getZ(), Math.floor(random(1, 101)));
		            staticContainer.addChild(temp.container);
		            pokemons.push(temp);
					// world.add(pokemons[pokemons.length - 1].container);
				}
				else {
					var temp = new Pokemon(this.pokemonName, this.shadow, this.container.getX(), this.yConstrain, this.container.getZ(), Math.floor(random(1, 101)));
		            staticContainer.addChild(temp.container);
		            pokemons.push(temp);
					// world.add(pokemons[pokemons.length - 1].container);
				}
				...
				if (this.pokemonName == "magnemite") {
					var temp = new Pokemon(this.pokemonName, this.shadow, this.container.getX(), this.container.getY() * scaleFactor, this.container.getZ(), Math.floor(random(1, 101)));
		            staticContainer.addChild(temp.container);
		            pokemons.push(temp);					// world.add(pokemons[pokemons.length - 1].container);
					var temp = new Pokemon(this.pokemonName, this.shadow, this.container.getX(), this.container.getY() * scaleFactor, this.container.getZ(), Math.floor(random(1, 101)));
		            staticContainer.addChild(temp.container);
		            pokemons.push(temp);					// world.add(pokemons[pokemons.length - 1].container);
				}
